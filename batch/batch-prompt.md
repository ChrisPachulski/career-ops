...
**RULE: NEVER hardcode metrics.** Read them from cv.md + article-digest.md at runtime.
...
Classify the offer into one of the 6 archetypes. If it is a hybrid, indicate the 2 closest.
...
| **Technical AI Product Manager** | GenAI/Agents, PRDs, discovery, delivery | Someone who translates business into AI product |
...
- Rephrase real experience using the exact vocabulary from the JD
...
3. Cite exact lines from the CV when there is a match

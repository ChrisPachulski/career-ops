...
4. **Generate message** using a 3-sentence framework adapted to the contact type:
   ...
   - **Sentence 2 (Proof)**: The candidate's biggest quantifiable achievement that demonstrates they have solved similar problems
   ...
   - **Sentence 1 (Research)**: A reference to something specific about their work or career path
